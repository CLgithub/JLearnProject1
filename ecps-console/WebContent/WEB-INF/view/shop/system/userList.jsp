...
//			alert(curentPage+","+pageSize);
			location.replace("http://localhost:8091/ecps-console/sysUserController/toUserList.action?currentPage="+curentPage+"&pageSize="+pageSize)
		}
	});
</script>
</html>
